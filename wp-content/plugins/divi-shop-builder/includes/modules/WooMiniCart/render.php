...
?>
<a href="<?php if ($props['action_click'] == 'cartpage' || (isset($props['action_click_mobile']) && $props['action_click_mobile'] == 'cartpage')) echo(esc_url(wc_get_cart_url())); else echo('#'); ?>" title="<?php echo(esc_attr($props['label'])); ?>"  class="dswcp-cart-link <?php if (!$cartCount) { ?>dswcp-cart-empty<?php } ?>">
	<?php if ($props['show_amount'] == 'on' && $props['amount_position'] == 'before') { ?>
    ...
    <span class="dswcp-cart-icon-wrapper">
        ...
        <?php if ($props['show_count'] === 'on' && ($cartCount || $props['show_count_zero'] === 'on')) { ?>
    ...
    <?php  if($props['show_quantity_label'] === 'on' && $props['quantity_label_position'] == 'after' && ($cartCount || $props['show_count_zero'] === 'on')) {?>
    <span class="dswcp-count-label"><?php echo(esc_attr(str_replace('%d', $cartCount, $props['count_title_plural']))); ?></span>
    <?php } ?>

		
	<?php if ($props['show_amount'] == 'on' && $props['amount_position'] == 'after') { ?>
	<span class="dswcp-amount">
		<?php echo(et_core_intentionally_unescaped(wc_price($cartSubtotal), 'html')); ?>
	</span>
	<?php } ?>
