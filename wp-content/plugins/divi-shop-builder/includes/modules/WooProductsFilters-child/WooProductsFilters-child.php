	...
	function get_fields() {
		...
		$fields = array(
			...
			'range_max'                  => array(
				...
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__('Choose the Deafult Maximum Price Amount.', 'divi-shop-builder'),
				'default'          => '1000',
				'toggle_slug'      => 'advanced_filter_settings',
				'show_if'          => array(
					'choose_filter' => 'price',
			...
			'display_as_toggle'          => array(
				...
				'description'      => esc_html__('Make the filter title a toggle that can be used to show or hide the corresponding filtering settings.', 'divi-shop-builder'),
				'type'             => 'yes_no_button',
				'options'          => array(
