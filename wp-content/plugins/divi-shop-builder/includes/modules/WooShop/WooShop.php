		...
		$fields = array(
			'type'                => array(
				...
				'options'          => array(
					...
					'product_attribute' => esc_html__( 'Product Attribute', 'divi-shop-builder' ),
				),
			...
			'include_attribute_values'  => array(
...
//				),
		...
		foreach ([
			...
			switch ($var) {
				case 'shopAttribute':
					$description = esc_html__('Enter the query variable to be used for Attribute filters. You must include one "%s" in the field (without quotes) since this will be replaced with the attribute name. Do not use spaces or special characters (besides "%" in "%s"), or a query variable that is already in use for another filter or other functionality (for example: "orderby" or "p").', 'divi-shop-builder');
					$default = 'shopAttribute_%s';
					break;
				case 'shopTaxonomy':
					$description = esc_html__('Enter the query variable to be used for Custom Taxonomy filters. You must include one "%s" in the field (without quotes) since this will be replaced with the attribute name. Do not use spaces or special characters (besides "%" in "%s"), or a query variable that is already in use for another filter or other functionality (for example: "orderby" or "p").', 'divi-shop-builder');
					$default = 'shopTaxonomy_%s';
					break;
				default:
					// translators: %s replaced with filter type
					$description = sprintf(esc_html__('Enter the query variable to be used for the %s filter. Do not use spaces or special characters, or a query variable that is already in use for another filter or other functionality (for example: "orderby" or "p").', 'divi-shop-builder'), $label);
