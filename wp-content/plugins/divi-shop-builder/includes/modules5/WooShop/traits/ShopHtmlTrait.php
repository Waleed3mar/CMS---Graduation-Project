...
trait ShopHtmlTrait {
	...
	function get_shop( $args = array(), $conditional_tags = array(), $current_page = array() ) {
		...
		} else if ('product_attribute' == $type) {
			$custom_taxonomy = wc_attribute_taxonomy_name_by_id((int) $this->props['include_attribute']);
			$custom_taxonomy_terms = $this->props['include_attribute_values'] ? array_map('absint', explode(',', $this->props['include_attribute_values'])) : [];
		}
