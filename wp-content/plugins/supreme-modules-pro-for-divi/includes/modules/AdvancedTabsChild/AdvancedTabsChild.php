...
class DSM_Advanced_Tabs_Child extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$tab_markup = '';
		$tab_markup = sprintf(
			'<div id="dsm-tab-%6$s" class="dsm-tab %4$s%5$s%10$s%14$s" role="tab"  aria-selected="true" aria-controls="dsm-panel-%11$s" tabindex="0">
			     %3$s
			     %2$s
				 %13$s
				 %12$s 
		...
		$content_markup = sprintf(
			'<div id="dsm-panel-%10$s" class="dsm-content-wrapper %5$s animated%7$s%8$s" aria-labelledby="dsm-tab-%9$s">
