jQuery(function($) {
  ...
  const content = "Your content goes here. Edit or remove this text inline or in the module Content settings. You can also style every aspect of this content in the module Design settings and even apply custom CSS to this text in the module Advanced settings.";
  const flipBoxContent =
    "Put your actual text here.";
  ...
  if (
    ...
    window.ETBuilderBackendDynamic.defaults.dnxte_flip_box = {
      front_heading: "Front Title",
      back_heading: "Back Title",
      front_content: `<p>${flipBoxContent}</p>`,
      back_content: `<p>${flipBoxContent}</p>`,
    };
    ...
    window.ETBuilderBackendDynamic.defaults.dnxte_thumbs_gallery_child = {
      ...
      dnxte_thumbs_gallery_title: "Thumbs Gallery Title",
      dnxte_thumbs_gallery_content: "Your Content Text Goes Here",
      dnxte_thumbs_gallery_button_text: "Button Text",
    };
